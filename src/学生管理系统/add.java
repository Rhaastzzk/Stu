	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == b0) {
			...
			try {
				...
				if(JDB1.rs.next()) new J10().setTitle("添加失败！！！");
			...
			try {
				...
				sql = "insert into class(con,cname,ctime) values('"+con+"','"+cname+"','"+ctime+"')";
				System.out.println(sql);
				x.execute(sql);
			}catch(Exception e1) {
				System.err.println(e1.getMessage());
			...
			try {
				...
				sql = "insert into sc(sno,con,time) values('"+sno+"','"+con+"','"+time+"')";
				System.out.println(sql);
				x.execute(sql);
			}catch(Exception e1) {
				System.err.println(e1.getMessage());
			...
			try {
				...
				sql = "insert into grade(sno,con,grade) values('"+sno+"','"+con+"',"+grade+")";
				System.out.println(sql);
				x.execute(sql);
			}catch(Exception e1) {
				System.err.println(e1.getMessage());
